...
// var findedProduct = products.find(x => x.id == 10);
// console.log("13.product",findedProduct);

// var findedProduct2 = products.find(x => x.categoryId = 5);
// console.log("catogryID=5: ",findedProduct2);

// products.forEach(function(item){
//     if(item.category != undefined)
//         console.log("categoryName: ",item.category?.name);
// })

var findedProduct3 = products.filter(x =>x.discontinued != false);
findedProduct3.forEach(function(item)
{
