...
var orderInBrazil = orders.filter(x => x.shipAddress.country == "Brazil");
orderInBrazil.forEach(function(item){
    console.log("country: ", item.shipAddress.city);
})
console.log("brazilyaya sipariş sayısı:", orderInBrazil.length);
var sum = 0;
orderInBrazil.forEach(function(item){
